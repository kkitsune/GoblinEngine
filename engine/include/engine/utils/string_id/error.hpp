...
namespace foonathan { namespace string_id
{
    ...
    class ENGINE_API error : public std::exception
    {
    protected:
        error() = default;
    };
    ...
    class ENGINE_API collision_error : public error
    {
    public:
    ...
    /// \detail This function is thread safe if \ref FOONATHAN_STRING_ID_ATOMIC_HANDLER is \c true.
    ENGINE_API generation_error_handler set_generation_error_handler(generation_error_handler h);
    
    /// \brief Returns the current \ref generation_error_handler.
    ENGINE_API generation_error_handler get_generation_error_handler();
    
    /// \brief The exception class thrown by the default \ref generation_error_handler.
    class ENGINE_API generation_error : public error
    {
    public:
        //=== constructor/destructor ===//
