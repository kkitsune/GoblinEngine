...
{    
    ...
    class ENGINE_API dummy_database : public basic_database
    {
    public:        
    ...
    class ENGINE_API map_database : public basic_database
    {
    public:        
    ...
    class ENGINE_API thread_safe_database : public Database
    {
    public:
