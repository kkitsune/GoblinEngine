...
namespace foonathan { namespace string_id
{
    namespace detail
    {
        ENGINE_API bool handle_generation_error(std::size_t counter, const char *name, const string_id &result);
    ...
    class ENGINE_API counter_generator
    {
    public:
    ...
    struct ENGINE_API character_table
    {
    ...
    class ENGINE_API random_generator
    {        
    public:        
